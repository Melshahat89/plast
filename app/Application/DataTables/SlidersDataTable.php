    ...
    public function ajax()
    {
        return datatables()
            ...
            ->addColumn('image', function($slider) {
                return '<img src="' . small($slider->image) . '" style="max-height:60px;" />';
            })
             /*->addColumn('name', 'admin.slider.buttons.langcol')*/
             ->rawColumns(['id', 'edit', 'delete', 'view', 'image'])
             ->make(true);
    }
    /**
    ...
    protected function getColumns()
    {
        return [
			...
			[
                ...
                'title' => "صورة",
//                'render' => 'function( ){
//                                       return \'<img src="http://127.0.0.1:8000/uploads/files/small/\'+JSON.parse(this.image)+\'" /> \';
//                                    }',
                ],
             [
                  'name' => 'view',
